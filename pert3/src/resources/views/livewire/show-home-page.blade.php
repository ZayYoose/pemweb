          ...
          <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
              <div class="block text-center text-lg-start pe-0 pe-xl-5">
                <h1 class="text-capitalize mb-4">APAPUN MASALAHNYA, TURU SOLUSINYA !!</h1>
                <p class="mb-4">hehe</p> <a type="button"
            ...
            <div class="col-lg-6">
              <div class="ps-lg-5 text-center">
                ...
                src="https://i.pinimg.com/736x/30/67/1c/30671c2d9d27193fa6746d32c3aa2896.jpg"
                alt="banner image" class="w-100"
                style="max-width: 80%; height: auto; border-radius: 12px;">              
              </div>
            </div>
          </div>
        </div>
